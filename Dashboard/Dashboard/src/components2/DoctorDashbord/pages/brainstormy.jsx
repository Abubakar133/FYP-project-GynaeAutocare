...
const brainstormy = () => {
  const handleChatOptionClick = async (option) => {
    const redirectURL = 'https://questionare-eight.vercel.app/';
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h2 style={{ margin: '0', fontWeight: 'bold', fontSize: '24px' }}>Brain Stormy</h2>
            <p style={{ margin: '10px 0', fontSize: '18px' }}>Nurturing minds, Elevating IQ's</p>
            <button
              style={{
                padding: '12px 24px',
